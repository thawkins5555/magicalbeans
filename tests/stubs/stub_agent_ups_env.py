...
CISCO_ENVMON_TABLE = {
    ...
    "1.3.6.1.4.1.9.9.13.1.4.1.2.2": ("str", "Fan tray 2"),
    "1.3.6.1.4.1.9.9.13.1.4.1.3.2": ("int", 1),        # normal
    # A third tray with a state row and NO description row: real Cisco gear
    # does this, and a read keyed on the description column lost it.
    "1.3.6.1.4.1.9.9.13.1.4.1.3.3": ("int", 1),        # normal
...
CISCO_DOM_THRESHOLD_TABLE = {
    ...
    "1.3.6.1.4.1.9.9.91.1.2.1.1.2.2001.2": ("int", 1),       # other
    "1.3.6.1.4.1.9.9.91.1.2.1.1.3.2001.2": ("int", 3),       # greaterThan
    "1.3.6.1.4.1.9.9.91.1.2.1.1.4.2001.2": ("int", 60),      # 60 C
}
