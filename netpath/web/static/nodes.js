...
(() => {
  ...
  /* drawSeriesChart, formatMetricValue and their private helpers now
     live in app.js (App.drawSeriesChart / App.formatMetricValue) so the
     Dashboard's new chart tiles can use them too; aliased here so the
     three Nodes charts that called them by these names are untouched. */
  const drawSeriesChart = App.drawSeriesChart;
  const formatMetricValue = App.formatMetricValue;
