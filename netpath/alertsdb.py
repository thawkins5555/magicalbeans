...
_BUILTIN_RULES = [
    ...
    # Shipped DISABLED (_BUILTIN_DISABLED): noisy on fleets with DARRP on.
...
class AlertsDatabase(SqliteStore):
    ...
    def _migrate(self) -> None:
        ...
        # One-time: built-in subjects go back to the shipped wording, edited or not.
        if not self._private_setting(self._TEMPLATE_SUBJECTS_RESET_5_30):
            self._conn.execute(
