...
| **Poller** | busy and queued work against the pool size, the floor and ceiling it is sizing itself between, and whether it has been at that ceiling long enough to raise `poll_pool_saturated` |
